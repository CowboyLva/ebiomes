...
--decors
	...
	minetest.register_decoration({
		name = "ebiomes:mushroom_brown_jp",
		deco_type = "simple",
		place_on = {"ebiomes:dirt_with_japanese_rainforest_litter"},
		sidelen = 16,
		noise_params = {
...
--mobs
--Forgotten monsters support has been added in forgotten_monsters.lua
--monsters
